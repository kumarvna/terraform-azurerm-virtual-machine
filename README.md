...
| <a name="input_availability_set_id"></a> [availability\_set\_id](#input\_availability\_set\_id) | Availability Set ID of availability set to add the Virtual Machine to. | `any` | `null` | no |
| <a name="input_availability_zone"></a> [availability\_zone](#input\_availability\_zone) | Index of availability zone in which the Virtual Machine should be deployed to. | `any` | `null` | no |
...
| <a name="input_identity_ids"></a> [identity\_ids](#input\_identity\_ids) | identity ids for virtual machine user assigned identities | `list` | `[]` | no |
| <a name="input_identity_type"></a> [identity\_type](#input\_identity\_type) | Virtual machine identity type. Can be SystemAssigned or UserAssigned | `string` | `""` | no |
...
| <a name="output_availability_zone"></a> [availability\_zone](#output\_availability\_zone) | Virtual machine availability zone |
| <a name="output_identity"></a> [identity](#output\_identity) | Virtual machine identity |
